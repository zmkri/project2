...
<head>
  ...
  <title>KPMG LUNCH APP |  @yield('title')</title>
    ...
    <div class="container ">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li class="active"><a href="{{ route('admin') }}" class="waves-effect waves-light">Admin <span class="sr-only">(current)</span></a>
          </li>
          <li class=""><a href="{{ route('onbehalf') }}" class="waves-effect waves-light">On Behalf</a>
          </li>
          <li class=""><a href="{{ route('todays-list') }}" class="waves-effect waves-light">Today's List</a>
          </li>
          <li class=""><a href="{{ route('addfood') }}" class="waves-effect waves-light">Add Foods</a>
          </li>
          <li class=""><a href="{{ route('old-list') }}" class="waves-effect waves-light">Old List</a>
          </li>
          <li class=""><a href="{{ route('addstaff') }}" class="waves-effect waves-light">Add Staff</a>
          </li>
